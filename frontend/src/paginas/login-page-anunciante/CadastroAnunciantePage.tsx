...
import './cadastroAnunciantePage.css';

const CadastroAnunciantePage: React.FC = () => {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage('Anunciante cadastrado com sucesso!');
      setTimeout(() => {
      ...
      alert('Erro ao cadastrar o anunciante. Por favor, tente novamente.');
    }
  };
...
export default CadastroAnunciantePage;